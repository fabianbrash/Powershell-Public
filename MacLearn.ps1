...
<#
## Get or set MAC Learning on 6.7
#>
...
Set-MacLearn -DVPortgroupName @("dvPG") -EnableMacLearn $true -EnablePromiscuous $false -EnableForgedTransmit $true -EnableMacChange $false


Get-MacLearn -DVPortgroupName @("dvPG")
