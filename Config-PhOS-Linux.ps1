...
echo 'Address=192.168.1.10/24' >> /etc/systemd/network/10-static-en.network
echo 'Gateway=192.168.1.1' >> /etc/systemd/network/10-static-en.network
echo 'DNS=8.8.8.8' >> /etc/systemd/network/10-static-en.network
echo 'Domains=photon.local' >> /etc/systemd/network/10-static-en.network
